...
/**
 * Servlet implementation class CalculatePremium
 */
public class CalculatePremium extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//session.getAttribute("PolicyQuestionsList");
		//request.setAttribute("PolicyQuestionsList",pqlist);
		PrintWriter out=response.getWriter();
		int totalPremium=0;
		/*for(PolicyQuestions pq:pqlist) {
			totalPremium+=Integer.parseInt(request.getParameter("Q"+count);
		}*/
