...
<label>
  <input name="submit2" type="submit" style="border-radius: 5em; background-color:#9C27B0; background: linear-gradient(to right, #9C27B0, #E040FB); color:white;" value="log out">
  </label>
</form>
</div>
